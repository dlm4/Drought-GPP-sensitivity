...
write.csv(flx_site_output_all, paste("../results/v4_ec_site_locations_combined_source/allmodels_gpp_precip_ec_sites_combined_source_data.csv", sep = ""), row.names = F)
