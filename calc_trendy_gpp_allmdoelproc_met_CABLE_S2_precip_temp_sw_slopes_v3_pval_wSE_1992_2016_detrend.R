...
#file_ind <- 15
  ...
  write_csv(df_spring, paste(prefix, "gppproc_met_CABLE_S2_precip_ta_par_df_spring_slope_se_1992_2016_detrend.csv", sep = ""))
  ...
  write_csv(df_summer, paste(prefix, "gppproc_met_CABLE_S2_precip_ta_par_df_summer_slope_se_1992_2016_detrend.csv", sep = ""))
  ...
  write_csv(df_fall, paste(prefix, "gppproc_met_CABLE_S2_precip_ta_par_df_fall_slope_se_1992_2016_detrend.csv", sep = ""))
}
registerDoSEQ()