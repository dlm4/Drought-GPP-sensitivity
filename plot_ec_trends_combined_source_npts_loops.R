...
for (npts_min in 5:20){
  ...
  ggsave(paste("figures/min_npts_looping/all_vars_seasons/added_sites_gpp_precip_ec_spring_cru_aridity_log10_slope_hist_AIthreshold_min", npts_min_text, ".png", sep = ""), 
  ...
  p_spring_slope_hist <- ggarrange(p_spring_slope, p_spring_hist, nrow = 1, align = "h", labels = "auto", widths = c(2,1))
  ggsave(paste("figures/min_npts_looping/all_vars_seasons/added_sites_gpp_precip_ec_spring_cru_aridity_log10_slope_hist_AIthreshold_IGBP_min", npts_min_text, ".png", sep = ""), 
         p_spring_slope_hist, width = 10, height = 5, units = "in")
}
...
for (npts_min in 5:20){
  ...
  title_phrase <- paste(npts_min, "+ years of data; ", nrow(flx_slope_merged_spring_par_sub), " flux sites", sep = "")
  ...
  p_spring_slope_hist <- ggarrange(p_spring_slope, p_spring_hist, nrow = 1, align = "h", labels = "auto", widths = c(2,1))
  ggsave(paste("figures/min_npts_looping/all_vars_seasons/added_sites_gpp_par_ec_spring_cru_aridity_log10_slope_hist_AIthreshold_min", npts_min_text, ".png", sep = ""), 
         p_spring_slope_hist, width = 10, height = 5, units = "in")
  ...
  p_spring_slope_hist <- ggarrange(p_spring_slope, p_spring_hist, nrow = 1, align = "h", labels = "auto", widths = c(2,1))
  ggsave(paste("figures/min_npts_looping/all_vars_seasons/added_sites_gpp_par_ec_spring_cru_aridity_log10_slope_hist_AIthreshold_IGBP_min", npts_min_text, ".png", sep = ""), 
         p_spring_slope_hist, width = 10, height = 5, units = "in")
}
...
for (npts_min in 5:20){
  ...
  title_phrase <- paste(npts_min, "+ years of data; ", nrow(flx_slope_merged_spring_ta_sub), " flux sites", sep = "")
  ...
  p_spring_slope <- ggplot(data = flx_slope_merged_spring_ta_sub, aes(x = CRU_Aridity_P_PET, y = Slope)) +
    ...
    stat_poly_eq(formula = log.formula, 
                 ...
                 parse = TRUE, size = 3.5, na.rm = TRUE,
                 label.y = 0.89, label.x = 0.9) +
    coord_cartesian(xlim = c(0, 4), ylim = c(-110, 110)) + # ylim = c(-1.3, 1.3)
    scale_x_continuous(breaks = c(0, 0.65, 1, 2, 3, 4), labels = c("0", "0.65", "1", "2", "3", "4")) + 
  ...
  p_spring_slope_hist <- ggarrange(p_spring_slope, p_spring_hist, nrow = 1, align = "h", labels = "auto", widths = c(2,1))
  ggsave(paste("figures/min_npts_looping/all_vars_seasons/added_sites_gpp_ta_ec_spring_cru_aridity_log10_slope_hist_AIthreshold_min", npts_min_text, ".png", sep = ""), 
         p_spring_slope_hist, width = 10, height = 5, units = "in")
  ...
  p_spring_slope_hist <- ggarrange(p_spring_slope, p_spring_hist, nrow = 1, align = "h", labels = "auto", widths = c(2,1))
  ggsave(paste("figures/min_npts_looping/all_vars_seasons/added_sites_gpp_ta_ec_spring_cru_aridity_log10_slope_hist_AIthreshold_IGBP_min", npts_min_text, ".png", sep = ""), 
         p_spring_slope_hist, width = 10, height = 5, units = "in")
}
...
for (npts_min in 5:20){
  ...
  #title_phrase <- paste(npts_min, "+ years of data; ", nrow(flx_slope_merged_sub_n)/3/3, " flux sites", sep = "")
  ...
  p_slope <- ggplot(data = flx_slope_merged_sub_n, aes(x = CRU_Aridity_P_PET, y = Slope)) +
    ...
    theme(#legend.position = c(0.85, 0.8), 
      ...
      panel.background = element_blank(), panel.border = element_rect(color = "black", fill = NA))
  #p_slope
  ggsave(paste("figures/min_npts_looping/all_vars_seasons/added_sites_gpp_all_test_", npts_min_text, ".png", sep = ""),
         p_slope, width = 10, height = 7, units = "in")
  # ggsave(paste("figures/min_npts_looping/all_vars_seasons/added_sites_gpp_all_test_noIL-Yat_", npts_min_text, ".png", sep = ""), 
  #        p_slope, width = 10, height = 7, units = "in")
}
