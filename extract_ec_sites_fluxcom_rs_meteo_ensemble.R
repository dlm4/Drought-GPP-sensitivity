...
setwd("/Users/davidmiller/dlm_files/keenan_postdoc/gpp_sif_gridded/source/FLUXCOM/ensemble")

fluxcom <- nc_open("GPP.RS_METEO.FP-ALL.MLM-ALL.METEO-ALL.720_360.monthly.2002.nc")
...
setwd('../../../fluxcom')
write.csv(ec_site_fluxcom_gpp_all, "ec_site_fluxcom_gpp_all_months.csv", row.names = FALSE)
...
write.csv(season_sum, "ec_site_fluxcom_gpp_all_seasons_sum.csv", row.names = FALSE)
