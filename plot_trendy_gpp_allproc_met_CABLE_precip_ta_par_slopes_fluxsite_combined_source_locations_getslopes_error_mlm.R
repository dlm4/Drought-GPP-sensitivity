...
#foreach (file_num = 1:length(file_list)) %do% {
  ...
  # save plot
  ggsave(paste("../results/v4_ec_site_locations_combined_source_error_mlm/", splitname[1], "_gpp_mlm_precip_ec_sites_", season_name, ".png", sep = ""), width = 5, height = 4, units = "in")
  ...
  # save plot
  ggsave(paste("../results/v4_ec_site_locations_combined_source_error_mlm/", splitname[1], "_gpp_mlm_precip_ec_sites_", season_name, "log10aridity.png", sep = ""), width = 5, height = 4, units = "in")
  
  # write out data frame to csv
  # actually includes gpp sensitivity to precip, ta, and par
  write.csv(flx_site_output, paste("../results/v4_ec_site_locations_combined_source_error_mlm/", splitname[1], "_gpp_mlm_allvar_ec_sites_combined_source_data_error_", season_name, ".csv", sep = ""), row.names = F)
...
write.csv(flx_site_output_all, paste("../results/v4_ec_site_locations_combined_source_error_mlm/allmodels_gpp_mlm_allvar_ec_sites_combined_source_data_error.csv", sep = ""), row.names = F)
...
setwd("../results/v4_ec_site_locations_combined_source_error_mlm/")
