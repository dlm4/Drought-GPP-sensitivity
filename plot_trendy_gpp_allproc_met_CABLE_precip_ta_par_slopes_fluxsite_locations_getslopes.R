...
for (trendyfile in file_list){
  ...
  # save plot
  ggsave(paste("../results/v4_ec_site_locations_combined_source/", splitname[1], "_gpp_precip_ec_sites_", season_name, ".png", sep = ""), width = 5, height = 4, units = "in")
  ...
  write.csv(flx_site_output, paste("../results/v4_ec_site_locations_combined_source/", splitname[1], "_gpp_precip_ec_sites_combined_source_data_", season_name, ".csv", sep = ""), row.names = F)
...
write.csv(flx_site_output_all, paste("../results/v4_ec_site_locations/allmodels_gpp_precip_ec_sites_combined_source_data.csv", sep = ""), row.names = F)
