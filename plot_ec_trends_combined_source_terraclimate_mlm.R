...
flx_info_merged <- merge(flx_site_info, flx_tc_vars_aridity, by = "SITE_ID")
flx_slope_merged <- merge(flx_info_merged, slope_data, by.y = "SITE_ID")
...
p_spring_slope_log10x_hist <- ggarrange(p_spring_slope_log10x, p_spring_hist, nrow = 1, align = "h", labels = "auto", widths = c(2,1))
# ggsave(paste("figures/tc_versions/mlm_gpp_precip_spring_igbp_logx_", npts_min_text, ".png", sep = ""), 
#        p_spring_slope_log10x_hist, width = 10, height = 5, units = "in")
# ggsave(paste("figures/tc_versions/mlm_gpp_precip_spring_igbp_logx_labs_", npts_min_text, ".png", sep = ""), 
#        p_spring_slope_log10x_hist, width = 10, height = 5, units = "in")
# ggsave(paste("figures/tc_versions/mlm_gpp_precip_spring_igbp_logx_error_", npts_min_text, ".png", sep = ""), 
#        p_spring_slope_log10x_hist, width = 10, height = 5, units = "in")
...
#ggsave(paste("figures/tc_versions/mlm_gpp_par_spring_igbp_logx_", npts_min_text, ".png", sep = ""),
#       p_spring_slope_log10x_hist_par, width = 10, height = 5, units = "in")
#ggsave(paste("figures/tc_versions/mlm_gpp_par_spring_igbp_logx_labs_", npts_min_text, ".png", sep = ""),
#       p_spring_slope_log10x_hist_par, width = 10, height = 5, units = "in")
#ggsave(paste("figures/tc_versions/mlm_gpp_par_spring_igbp_logx_error_", npts_min_text, ".png", sep = ""),
#       p_spring_slope_log10x_hist_par, width = 10, height = 5, units = "in")
...
#ggsave(paste("figures/tc_versions/mlm_gpp_ta_spring_igbp_logx_", npts_min_text, ".png", sep = ""),
#       p_spring_slope_log10x_hist_ta, width = 10, height = 5, units = "in")
#ggsave(paste("figures/tc_versions/mlm_gpp_ta_spring_igbp_logx_labs_", npts_min_text, ".png", sep = ""),
#       p_spring_slope_log10x_hist_ta, width = 10, height = 5, units = "in")
#ggsave(paste("figures/tc_versions/mlm_gpp_ta_spring_igbp_logx_error_", npts_min_text, ".png", sep = ""),
#       p_spring_slope_log10x_hist_ta, width = 10, height = 5, units = "in")
...
ggsave(paste("figures/tc_versions/mlm_gpp_all_igbp_logx_", npts_min_text, ".png", sep = ""),
       p_all_slope_log10x, width = 10, height = 8, units = "in")
#ggsave(paste("figures/tc_versions/mlm_gpp_all_igbp_logx_noIL-Yat_", npts_min_text, ".png", sep = ""),
#       p_all_slope_log10x, width = 10, height = 8, units = "in")
