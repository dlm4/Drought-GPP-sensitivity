...
latlim <- 15 # minimum latitude for analysis
...
# # set infinity values to NaN, array misalignment
# aridity_sub[which(aridity_sub == Inf)] <- NA
...
aridity_df_sub <- aridity_df[aridity_df$Lat > 15,]
rm(aridity_r)
gc()
...
# Change to use ORIGINAL GPP nc files, not the reprocessed mat files


#library(rhdf5)
#setwd("D:/berkeley/TRENDY/TRENDYv6_processed/GPP") # ext hard drive path
#setwd("/Users/davidmiller/dlm_files/keenan_postdoc/trendy/test_data") # ssd internal path
...
#file_ind <- 15
  ...
  getSlopeIntInfo <- function(gpp_vec, met_vec){
    ...
    return(c(slope_val, int_val, r2_val, p_val))
  }
  ...
  # output directory
  setwd("/Users/davidmiller/dlm_files/keenan_postdoc/trendy/gpp_precip_slope_v4_pval/")
  ...
  df_spring <- cbind.data.frame(lonlat_sub, aridity_df_sub$Aridity_P_PET, c(umdlc_mat_sub), c(modis_pft_sub),
                                ...
                                c(gpp_pre_slope_spring), c(gpp_pre_intercept_spring), c(gpp_pre_r2_spring), c(gpp_pre_pval_spring), #c(gpp_pre_slope_spring), # this last part should have been p_val
                                c(gpp_ta_slope_spring), c(gpp_ta_intercept_spring), c(gpp_ta_r2_spring), c(gpp_ta_pval_spring), #c(gpp_ta_slope_spring),
                                c(gpp_par_slope_spring), c(gpp_par_intercept_spring), c(gpp_par_r2_spring), c(gpp_par_pval_spring), #c(gpp_par_slope_spring))
  colnames(df_spring) <- c("Lon", "Lat", "Aridity", "UMD_LC", "MODIS_LC", "GPP_gCm2", "Precip_mm", "Ta_K", "PAR_MJm2", 
                           "Precip_Slope", "Precip_Intercept", "Precip_R2", "Precip_pval",
                           "Ta_Slope", "Ta_Intercept", "Ta_R2", "Ta_pval",
                           "PAR_Slope", "PAR_Intercept", "PAR_R2", "PAR_pval")
  ...
  write_csv(df_spring, paste(prefix, "gppproc_met_CABLE_S2_precip_ta_par_df_spring_slope.csv", sep = ""))
  ...
  df_summer <- cbind.data.frame(lonlat_sub, aridity_df_sub$Aridity_P_PET, c(umdlc_mat_sub), c(modis_pft_sub),
                                ...
                                c(gpp_pre_slope_summer), c(gpp_pre_intercept_summer), c(gpp_pre_r2_summer), c(gpp_pre_pval_summer, # c(gpp_pre_slope_summer),
                                c(gpp_ta_slope_summer), c(gpp_ta_intercept_summer), c(gpp_ta_r2_summer), c(gpp_ta_pval_summer), #c(gpp_ta_slope_summer),
                                c(gpp_par_slope_summer), c(gpp_par_intercept_summer), c(gpp_par_r2_summer), c(gpp_par_pval_summer), #c(gpp_par_slope_summer))
  ...
  write_csv(df_summer, paste(prefix, "gppproc_met_CABLE_S2_precip_ta_par_df_summer_slope.csv", sep = ""))
  ...
  df_fall <- cbind.data.frame(lonlat_sub, aridity_df_sub$Aridity_P_PET, c(umdlc_mat_sub), c(modis_pft_sub),
                                ...
                                c(gpp_pre_slope_fall), c(gpp_pre_intercept_fall), c(gpp_pre_r2_fall), c(gpp_pre_pval_fall), #c(gpp_pre_slope_fall),
                                c(gpp_ta_slope_fall), c(gpp_ta_intercept_fall), c(gpp_ta_r2_fall), c(gpp_ta_pval_fall), #c(gpp_ta_slope_fall),
                                c(gpp_par_slope_fall), c(gpp_par_intercept_fall), c(gpp_par_r2_fall), c(gpp_par_pval_fall), #c(gpp_par_slope_fall))
  ...
  write_csv(df_fall, paste(prefix, "gppproc_met_CABLE_S2_precip_ta_par_df_fall_slope.csv", sep = ""))
}